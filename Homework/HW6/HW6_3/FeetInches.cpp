...
double FeetInches::getProductFeet()
{
    return productFeet;
}
double FeetInches::getProductInches()
{
...
{
    FeetInches temp;
    temp.productInches = ((feet*12.0 +inches) * (rhs.feet*12.0 + rhs.inches));
    temp.productFeet = temp.productInches/144.0;
    //Will return the product of left and the right in square square feet
    return temp;
}
